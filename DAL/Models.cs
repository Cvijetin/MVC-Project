...
//     Connection String:      "Data Source=localhost\SQLEXPRESS;Initial Catalog=CarManagement;Integrated Security=True;"
// ------------------------------------------------------------------------------------------------
...
namespace DAL
{
    ...
    public class VehicleMake
    {
        ...
        public string Abrv { get; set; } // Abrv (length: 50)

        // Reverse navigation

        /// <summary>
        /// Child VehicleModels where [VehicleModel].[MakeId] point to this entity (FK_VehicleMake_VehicleModel)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<VehicleModel> VehicleModels { get; set; } // VehicleModel.FK_VehicleMake_VehicleModel
    ...
    public class VehicleModel
    {
        ...
        /// <summary>
        /// Parent VehicleMake pointed by [VehicleModel].([MakeId]) (FK_VehicleMake_VehicleModel)
        /// </summary>
        public virtual VehicleMake VehicleMake { get; set; } // FK_VehicleMake_VehicleModel
    }
    ...
    public class VehicleMakeConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<VehicleMake>
    {
        ...
        public VehicleMakeConfiguration(string schema)
        {
            ...
            Property(x => x.Abrv).HasColumnName(@"Abrv").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(50);
        }
    }
    ...
    public class VehicleModelConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<VehicleModel>
    {
        ...
        public VehicleModelConfiguration(string schema)
        {
            ...
            Property(x => x.Id).HasColumnName(@"Id").HasColumnType("int").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.Identity);
            Property(x => x.MakeId).HasColumnName(@"MakeId").HasColumnType("int").IsRequired();
            Property(x => x.Name).HasColumnName(@"Name").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(50);
            Property(x => x.Abrv).HasColumnName(@"Abrv").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(50);

            // Foreign keys
            HasRequired(a => a.VehicleMake).WithMany(b => b.VehicleModels).HasForeignKey(c => c.MakeId).WillCascadeOnDelete(false); // FK_VehicleMake_VehicleModel
        }
    }
